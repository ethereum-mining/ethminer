...
public:
	...
	struct LightAllocation
	{
		...
		Result compute(h256 const& _headerHash, uint64_t const& _nonce) const;
	...
	static Result eval(h256 const& _seedHash, h256 const& _headerHash, uint64_t const&  _nonce) noexcept;
