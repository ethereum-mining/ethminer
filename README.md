...
2. No reserve group: Thus, there’s no reserve pool of hardware or reserve pool of interest parties to jump in when things are volatile and attractive for manipulation. 
...
4. Delegated centralization vs physical centralization: While pool centralization is a delegated. Hardware monoculture is not: only the limiter buyers of this hardware can participate so there isn’t even the possibility of divesting control.
